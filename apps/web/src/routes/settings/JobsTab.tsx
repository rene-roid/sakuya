...
export function JobsTab() {
  ...
  return (
    <div>
      <TabHeader title="Import / Jobs" subtitle="Recent scan and tagging jobs." />
      <div className="flex flex-col gap-2.5">
        ...
        {jobs.length === 0 && <div className="text-[12.5px] text-zinc-600">No jobs yet. Scan a library to get started.</div>}
      </div>
    </div>
  );
}
